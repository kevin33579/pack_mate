...
class AddItemsShared extends StatefulWidget {
  final String userId;
  final String partyId;

  AddItemsShared({required this.userId, required this.partyId});

  @override
  _AddItemsSharedState createState() => _AddItemsSharedState();
}
